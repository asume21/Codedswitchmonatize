...
function makeCtx(overrides: Partial<OrganismContextValue> = {}): OrganismContextValue {
  return {
    ...
    melodyVolume: 1,
    chordVolume: 1,
    melodyFocusEnabled: false,
    setHatDensity: vi.fn(),
    setKickVelocity: vi.fn(),
    setDrumsVolume: vi.fn(),
    setBassVolume: vi.fn(),
    setMelodyVolume: vi.fn(),
    setChordVolume: vi.fn(),
    setMelodyFocusEnabled: vi.fn(),
    textureEnabled: false,
    setTextureEnabled: vi.fn(),
    instrumentAssignments: { lead: null, bass: null, chord: null },
    setOrganismInstrument: vi.fn(),
