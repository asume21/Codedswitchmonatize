...
export default function MakeSurface() {
  ...
  return (
    <div className="min-h-[calc(100vh-3rem)] bg-background text-foreground">
      ...
      {/* Lyric Video Maker MOVED 2026-07-23 → SHARE surface. It makes a shareable
          video from a finished song (post-production output), so it does not
          belong on MAKE (live performance). */}
