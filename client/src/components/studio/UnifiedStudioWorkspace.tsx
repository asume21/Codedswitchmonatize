...
export default function UnifiedStudioWorkspace() {
  ...
  return (
    ...
    <div className="h-full w-full flex flex-col bg-black astutely-app astutely-scanlines astutely-grid-bg astutely-scrollbar overflow-visible">
      ...
      {/* Floating Transport Bar REMOVED 2026-08-01. Disabled in place on 2026-07-23
          with `false &&` because it duplicated the canonical full-width
          GlobalTransportBar (z-40) and rendered on top of it, overlapping the
          timeline. That left 166 lines of JSX that could never render, and ESLint
          correctly flagged the constant condition (no-constant-binary-expression) —
          which is what finally surfaced it. One transport, one source of truth. */}
    </div>
    <UpgradeModal
