...
describe('MasterBus', () => {
  ...
  it('dispose() cleans up all nodes', () => {
    ...
    // 12 nodes: input, masterGain, lowShelf, midCut, highShelf, hiCut,
    // compressor, saturator, safetyClip, limiter, tapGain, analyser
    expect(mockDispose).toHaveBeenCalledTimes(12)
  })
})
