...
export const PRODUCER_ARRANGEMENT: ProducerArrangementSlot[] = [
  { name: 'intro',     bars: 4,  drums: 0.45, bass: 0.58, melody: 0.88, chord: 0.82, texture: 0, energy: 0.35, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'verse',     bars: 8,  drums: 0.78, bass: 0.94, melody: 0.92, chord: 0.78, texture: 0, energy: 0.62, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'build',     bars: 4,  drums: 0.90, bass: 0.98, melody: 1.00, chord: 0.85, texture: 0, energy: 0.82, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'drop',      bars: 8,  drums: 1.00, bass: 1.00, melody: 1.05, chord: 0.85, texture: 0, energy: 1.00, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'breakdown', bars: 4,  drums: 0.52, bass: 0.68, melody: 0.85, chord: 0.92, texture: 0, energy: 0.42, drumDropout: false, bassDropout: false, melodyDropout: false },
  ...
  { name: 'verse',     bars: 8,  drums: 0.80, bass: 0.94, melody: 0.95, chord: 0.80, texture: 0, energy: 0.65, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'build',     bars: 4,  drums: 0.92, bass: 0.98, melody: 1.05, chord: 0.86, texture: 0, energy: 0.85, drumDropout: false, bassDropout: false, melodyDropout: false },
  { name: 'drop',      bars: 8,  drums: 1.00, bass: 1.00, melody: 1.10, chord: 0.88, texture: 0, energy: 1.00, drumDropout: false, bassDropout: false, melodyDropout: false },
  // Outro fades the energy down so the loop wrap into intro feels intentional.
  { name: 'outro',     bars: 12, drums: 0.40, bass: 0.55, melody: 0.75, chord: 0.82, texture: 0, energy: 0.30, drumDropout: false, bassDropout: false, melodyDropout: false },
]
